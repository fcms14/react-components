import {ButtonElementInterface, ButtonInterface} from "./ButtonInterface"
    ...
    const ButtonContent = (props: ButtonInterface) => {
        ...
        return (
            <div className={buttonLayout && (iconOnly && 'iconOnlyClass')}>
                ...
                { (iconOnly || (icon && iconPosition == 'left' || iconPosition == null)) && <Icon width={sizeIcon} color={iconColor} icon={icon} /> }
